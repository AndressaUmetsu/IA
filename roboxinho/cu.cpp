    ...
    while ( 1 ){
        while ( !c.empty() ) {
            ...
            if ( lugar.y > 0 && !map[lugar.x][lugar.y-1].visited ){
                map[lugar.x][lugar.y-1].cu = map[lugar.x][lugar.y].cu + (map[lugar.x][lugar.y-1].type + 1) * ((map[lugar.x][lugar.y-1].type + 1) > 1 ? (map[lugar.x][lugar.y-1].type + 1) * 5 : 1);
            ...
            if ( lugar.x > 0 && !map[lugar.x-1][lugar.y].visited){
                map[lugar.x-1][lugar.y].cu = map[lugar.x][lugar.y].cu + (map[lugar.x-1][lugar.y].type + 1) * ((map[lugar.x-1][lugar.y].type + 1) > 1 ? (map[lugar.x-1][lugar.y].type + 1) * 5 : 1);
